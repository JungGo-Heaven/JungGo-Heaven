...
import com.example.junggoheaven.global.websocket.StompJwtChannelInterceptor;
...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    public void configureClientInboundChannel(ChannelRegistration registration) {
        registration.interceptors(new StompJwtChannelInterceptor(jwtUtil));
    }
    ...
    public void configureWebSocketTransport(org.springframework.web.socket.config.annotation.WebSocketTransportRegistration registry) {
        registry.setSendTimeLimit(30 * 1000)        // 30초
